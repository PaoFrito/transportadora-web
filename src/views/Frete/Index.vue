<template>
    <div>
        ...
        <div>
            <!-- Atualizado -->
            <div v-if="curStatusFrete == statusfrete.faturado" class="modal"
                v-bind:class="{ 'modal is-active': modal.getState() }">
            ...
            <!-- Descarga -->
            <div v-if="curStatusFrete == statusfrete.descarga" class="modal"
                v-bind:class="{ 'modal is-active': modal.getState() }">
                <div class="modal-background"></div>
                <div class="modal-card">
                    <header class="modal-card-head">
                            ...
                            <div class="container">
                                ...
                                <div class="container">
                                    <b-field label="Quilometragem Fim">
                                        <b-numberinput step="5" min-step="0.01" aria-minus-label="Decrement by 5"
                                            aria-plus-label="Increment by 5"
                                            v-model="freteDescarga.quilometragemFim"></b-numberinput>
                                    </b-field>
                                </div>
                                <div class="division"></div>
                                <div class="container">
                                    <b-field label="Peso Final">
                                        <b-numberinput step="1" min-step="0.01" aria-minus-label="Decrement by 1"
                                            aria-plus-label="Increment by 1"
                                            v-model="freteDescarga.pesoFinal"></b-numberinput>
                                    </b-field>
                                </div>
                            </div>
                        </form>
            ...
            <!-- Em transporte -->
            <div v-if="curStatusFrete == statusfrete.em_transporte" class="modal"
                v-bind:class="{ 'modal is-active': modal.getState() }">
                <div class="modal-background"></div>
                <div class="modal-card">
                    <header class="modal-card-head">
                            ...
                            <div class="container">
                                ...
                                <div class="container">
                                    <b-field label="Quilometragem Inicial">
                                        <b-numberinput step="5" min-step="0.01" aria-minus-label="Decrement by 5"
                                            aria-plus-label="Increment by 5"
                                            v-model="freteEmTransporte.quilometragemIni"></b-numberinput>
                                    </b-field>
                                </div>
                                <div class="division"></div>
                                <div class="container">
                                    <b-field label="Peso Inicial">
                                        <b-numberinput step="1" min-step="0.01" aria-minus-label="Decrement by 1"
                                            aria-plus-label="Increment by 1"
                                            v-model="freteEmTransporte.pesoInicial"></b-numberinput>
                                    </b-field>
                                </div>
                            </div>
                        </form>
            ...
            <!-- Observacao -->
            <div v-if="curStatusFrete == statusfrete.interrompido || curStatusFrete == statusfrete.cancelado"
                class="modal" v-bind:class="{ 'modal is-active': modal.getState() }">
                <div class="modal-background"></div>
                <div class="modal-card">
                    <header class="modal-card-head">
                        <p class="modal-card-title">Atualizar Frete</p>
                            ...
                            <td>
                                <div class="buttons">
                                    ...
                                    <div v-if="frete.statusFrete === statusfrete.carga">
                                        <b-button class="is-small" type="is-primary" outlined
                                            @click="openModal(frete, statusfrete.em_transporte)"><abbr
                                                title="Em Transporte">Et</abbr></b-button>
                                    </div>

                                    <!-- btn descarga -->
                                    <div
                                        v-if="frete.statusFrete == statusfrete.em_transporte || frete.statusFrete == statusfrete.interrompido">
                                        <b-button class="is-small" type="is-primary" outlined
                                            @click="openModal(frete, statusfrete.descarga)"><abbr
                                                title="Descarga">De</abbr></b-button>
                                    </div>

                                    <!-- btn faturado -->
                                    <div v-if="frete.statusFrete == statusfrete.descarga">
                                        <b-button class="is-small" type="is-primary" outlined
                                            @click="openModal(frete, statusfrete.faturado)"><abbr
                                                title="Faturado">Fa</abbr></b-button>
                                    </div>

                                    <!-- btn cancelado -->
                                    <div v-if="frete.statusFrete == statusfrete.carga">
                                        <b-button class="is-small" type="is-primary" outlined
                                            @click="openModal(frete, statusfrete.cancelado)"><abbr
                                                title="Cancelado">Ca</abbr></b-button>
                                    </div>

                                    <!-- btn interrompido -->
                                    <div
                                        v-if="frete.statusFrete == statusfrete.em_transporte || frete.statusFrete == statusfrete.carga">
                                        <b-button class="is-small" type="is-primary" outlined
                                            @click="openModal(frete, statusfrete.interrompido)"><abbr
                                                title="Interrompido">In</abbr></b-button>
                                    </div>
                                </div>
                            </td>
                        </tr>
