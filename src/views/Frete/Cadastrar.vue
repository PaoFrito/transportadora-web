                                ...
                                <div class=" is-small columns">
                                    <div class="column">
                                        <b-field label="Estado de Origem">
                                            <b-select @change.native="getCidadesOrigem($event)"
                                                placeholder="-- Selecione --">
                                                <option v-for="estado in estadoList" :value="estado.id"> {{ estado.nome
                                                }} </option>
                                            </b-select>
                                        </b-field>
                                    </div>
                                    <div class="column">
                                        <b-field label="Cidade de Origem">
                                            <b-select v-model="frete.cidadeOrigem" placeholder="-- Selecione --"
                                                :disabled="CDO">
                                                <option v-for="cidade in cidadeOrigemList" :value="cidade"> {{
                                                        cidade.nome
                                                }} </option>
                                            </b-select>
                                        </b-field>
                                ...
                                <div class=" is-small columns">
                                    <div class="column">
                                        <b-field label="Estado de Destino">
                                            <b-select placeholder="-- Selecione --"
                                                @change.native="getCidadesDestino($event)">
                                                <option v-for="estado in estadoList" :value="estado.id"> {{ estado.nome
                                                }} </option>
                                            </b-select>
                                        </b-field>
                                    ...
                                    <div class="column">
                                        <b-field label="Cidade de Destino">
                                            <b-select v-model="frete.cidadeDestino" placeholder="-- Selecione --"
                                                :disabled="CDD">
                                                <option v-for="cidade in cidadeDestinoList" :value="cidade"> {{
                                                        cidade.nome
                                                }} </option>
                                            </b-select>
                                        </b-field>
                                ...
                                <div>
                                    <b-field label="Produto">
                                        <b-select v-model="frete.produto" placeholder="-- Selecione --">
                                            <option v-for="produto in produtoList" :value="produto"> {{ produto.nome }}
                                            </option>
                                        </b-select>
                                    </b-field>
                                </div>
                                ...
                                <div>
                                    <b-field label="Caminhao">
                                        <b-select v-model="frete.caminhao" placeholder="-- Selecione --">
                                            <option v-for="caminhao in caminhaoList" :value="caminhao"> {{
                                                    caminhao.placa
                                            }} </option>
                                        </b-select>
                                    </b-field>
                                ...
                                <div>
                                    <b-field label="Motorista">
                                        <b-select v-model="frete.motorista" placeholder="-- Selecione --">
                                            <option v-for="motorista in motoristaList" :value="motorista"> {{
                                                    motorista.nome
                                            }} </option>
                                        </b-select>
                                    </b-field>
                            ...
                            <div class="container">
                                <div>
                                    <b-field label="Preco por Tonelada">
                                        <b-numberinput step="10" min-step="0.01" aria-minus-label="Decrement by 10"
                                            aria-plus-label="Increment by 10"
                                            v-model="frete.precoTonelada"></b-numberinput>
                                    </b-field>
                                </div>
                            </div>
...
export default class CadastrarFreteView extends Vue {
    ...
    private listaUsers(): void {
        this.userClient.findByRole(Grupo[Grupo.MOTORISTA])
            .then(
                res => {
